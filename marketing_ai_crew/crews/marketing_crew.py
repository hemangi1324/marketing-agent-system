...
AGENT_META = {
    "strategy":          ("Strategy & Planning",    1, "Full",      "blue"),
    "content":           ("Content & Branding",     1, "Full",      "green"),
    "risk":              ("Risk Check & Safety",    1, "Full",      "red"),
    "analytics":         ("Analytics & Research",   1, "Full",      "cyan"),
}
...
def run_full_crew(briefs: dict = None, verbose: bool = True):
    console.print(Panel(
        "[bold]Running all 4 marketing agents sequentially.[/bold]\n",
...
def print_menu():
    t = Table(title="Available Marketing Agents", show_lines=True)
